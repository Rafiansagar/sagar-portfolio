	...
	return (
		<div className="intro-my">
			...
			<div className="inrto-text mb-20">
				...
				<p className="desc"><i class="ri-user-6-line"></i> Lead Developer at #RSTheme | 7+ yrs WP + Full-Stack | Front-end <i class="ri-gemini-line"></i> Back-end <i class="ri-gemini-line"></i> Scalable Solutions | PHP • JS • React • HTML • CSS Wizardry</p>
			</div>
